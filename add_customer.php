...
<body>
  ...
  <h2>Add supplier</h2>
      <form action="customerfunction.php" method="POST" id="myForm" >
            <div class="form-group">
                <label> Customer name :</label>
                <input type="text" name="customername" class="form-control" placeholder="Enter customer name" id="customer_name"oninvalid="Invalidname1(this);" 
